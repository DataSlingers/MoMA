...
public:
    RcppFourDList(int n_alpha_u, int n_lambda_u, int n_alpha_v, int n_lambda_v) : n_alpha_u(n_alpha_u), n_lambda_u(n_lambda_u), n_alpha_v(n_alpha_v), n_lambda_v(n_lambda_v),
