...
class MoMALoggerMessage {
 public:
  MoMALoggerMessage(const char *header, MoMALoggerLevel msg_level,
...
class RHandleMoMALoggerMessage {
 public:
  RHandleMoMALoggerMessage(const char *header, MoMALoggerLevel msg_level,
                           MoMALoggerLevel logger_level) {
    this->msg_level = msg_level;
    this->logger_level = logger_level;
...
class MoMALogger {
 public:
  ...
  static RHandleMoMALoggerMessage error(const std::string &log_msg) {
    RHandleMoMALoggerMessage msg("[ERROR]", MoMALoggerLevel::ERRORS,
  ...
  static MoMALoggerMessage info(const std::string &log_msg) {
    MoMALoggerMessage msg("[INFO]", MoMALoggerLevel::INFO,
                          MoMALogger::get_level(), MoMALogger::get_ostream());
  ...
  static MoMALoggerMessage debug(const std::string &log_msg) {
    MoMALoggerMessage msg("[DEBUG]", MoMALoggerLevel::DEBUG,
                          MoMALogger::get_level(), MoMALogger::get_ostream());
